...
# bids_root: PathLike | None = "/Volumes/BerkStorage/datasets/syntax_im/syntax_dataset"
"""
...
notch_freq: float | Sequence[float] | None = None  # [50, 100]
"""
...
conditions: Sequence[str] | dict[str, str] | None = [
    *[
        "MINIBLOCK/" + "/".join(("TWOWORD", cond, freq))
        for cond in ["PHRASE", "NONPHRASE", "NONWORD"]
        for freq in ["F1LEFT", "F1RIGHT"]
    ],
    *[
        "MINIBLOCK/" + "/".join(("ONEWORD", cond, freq))
...
time_frequency_freq_min: float | None = 1.0
"""
...
time_frequency_cycles: float | FloatArrayLike | None = (
    np.arange(time_frequency_freq_min, time_frequency_freq_max) / 4
)
"""
...
time_frequency_crop: dict | None = dict(tmin=0.0, tmax=2.0, fmin=15.0, fmax=22.0)
"""
